...
XS(XS_nginx_status)
{
    dXSARGS;
    if (items != 2)
	Perl_croak(aTHX_ "Usage: nginx::status(r, code)");
    {
#line 104 "nginx.xs"
...
XS(XS_nginx_send_http_header)
{
    dXSARGS;
    if (items < 1)
	Perl_croak(aTHX_ "Usage: nginx::send_http_header(r, ...)");
    {
#line 120 "nginx.xs"
    ngx_http_request_t  *r;
    SV                  *sv;
...
XS(XS_nginx_header_only)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: nginx::header_only(r)");
    {
#line 153 "nginx.xs"
    dXSTARG;
    ngx_http_request_t  *r;
...
XS(XS_nginx_uri)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: nginx::uri(r)");
    {
#line 168 "nginx.xs"
    dXSTARG;
    ngx_http_request_t  *r;
...
XS(XS_nginx_args)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: nginx::args(r)");
    {
#line 181 "nginx.xs"
    dXSTARG;
    ngx_http_request_t  *r;
...
XS(XS_nginx_request_method)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: nginx::request_method(r)");
    {
#line 194 "nginx.xs"
    dXSTARG;
    ngx_http_request_t  *r;
...
XS(XS_nginx_remote_addr)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: nginx::remote_addr(r)");
    {
#line 207 "nginx.xs"
    dXSTARG;
    ngx_http_request_t  *r;
...
XS(XS_nginx_header_in)
{
    dXSARGS;
    if (items != 2)
	Perl_croak(aTHX_ "Usage: nginx::header_in(r, key)");
    {
#line 221 "nginx.xs"
    dXSTARG;
    ngx_http_request_t         *r;
...
XS(XS_nginx_has_request_body)
{
    dXSARGS;
    if (items != 2)
	Perl_croak(aTHX_ "Usage: nginx::has_request_body(r, next)");
    {
#line 353 "nginx.xs"
    dXSTARG;
    ngx_http_request_t   *r;
...
XS(XS_nginx_request_body)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: nginx::request_body(r)");
    {
#line 386 "nginx.xs"
    dXSTARG;
    ngx_http_request_t  *r;
...
XS(XS_nginx_request_body_file)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: nginx::request_body_file(r)");
    {
#line 414 "nginx.xs"
    dXSTARG;
    ngx_http_request_t  *r;
...
XS(XS_nginx_discard_request_body)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: nginx::discard_request_body(r)");
    {
#line 433 "nginx.xs"
    ngx_http_request_t  *r;
...
XS(XS_nginx_header_out)
{
    dXSARGS;
    if (items != 3)
	Perl_croak(aTHX_ "Usage: nginx::header_out(r, key, value)");
    {
#line 444 "nginx.xs"
    ngx_http_request_t  *r;
    SV                  *key;
...
XS(XS_nginx_filename)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: nginx::filename(r)");
    {
#line 482 "nginx.xs"
    dXSTARG;
    size_t                root;
...
XS(XS_nginx_print)
{
    dXSARGS;
    if (items < 1)
	Perl_croak(aTHX_ "Usage: nginx::print(r, ...)");
    {
#line 512 "nginx.xs"
    ngx_http_request_t  *r;
    SV                  *sv;
...
XS(XS_nginx_sendfile)
{
    dXSARGS;
    if (items < 2 || items > 4)
	Perl_croak(aTHX_ "Usage: nginx::sendfile(r, filename, offset = -1, bytes = 0)");
    {
#line 608 "nginx.xs"
    ngx_http_request_t        *r;
    char                      *filename;
...
XS(XS_nginx_flush)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: nginx::flush(r)");
    {
#line 694 "nginx.xs"
    ngx_http_request_t  *r;
    ngx_buf_t           *b;
...
XS(XS_nginx_internal_redirect)
{
    dXSARGS;
    if (items != 2)
	Perl_croak(aTHX_ "Usage: nginx::internal_redirect(r, uri)");
    {
#line 717 "nginx.xs"
    ngx_http_request_t   *r;
    SV                   *uri;
...
XS(XS_nginx_allow_ranges)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: nginx::allow_ranges(r)");
    {
#line 748 "nginx.xs"
    ngx_http_request_t  *r;
...
XS(XS_nginx_unescape)
{
    dXSARGS;
    if (items < 2 || items > 3)
	Perl_croak(aTHX_ "Usage: nginx::unescape(r, text, type = 0)");
    {
#line 759 "nginx.xs"
    dXSTARG;
    ngx_http_request_t  *r;
...
XS(XS_nginx_variable)
{
    dXSARGS;
    if (items < 2 || items > 3)
	Perl_croak(aTHX_ "Usage: nginx::variable(r, name, value = NULL)");
    {
#line 793 "nginx.xs"
    dXSTARG;
    ngx_http_request_t         *r;
...
XS(XS_nginx_sleep)
{
    dXSARGS;
    if (items != 3)
	Perl_croak(aTHX_ "Usage: nginx::sleep(r, sleep, next)");
    {
#line 929 "nginx.xs"
    ngx_http_request_t   *r;
    ngx_msec_t            sleep;
...
XS(XS_nginx_log_error)
{
    dXSARGS;
    if (items != 3)
	Perl_croak(aTHX_ "Usage: nginx::log_error(r, err, msg)");
    {
#line 954 "nginx.xs"
    ngx_http_request_t  *r;
    SV                  *err, *msg;
